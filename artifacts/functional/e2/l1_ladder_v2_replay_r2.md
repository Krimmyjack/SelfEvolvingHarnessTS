...
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 4 | producer_C_backup | GunPoint | 0 | 1 | 0 | `identity` | +0.0000 | +0.4067 | +0.0000 | 1 | 4 | 1 |
| 5 | beneficiary_strong | GunPointOldVersusYoung | 1 | 1 | 1 | `hampel_filter` | +0.2127 | -0.0286 | +0.1879 | 2 | 4 | 6 |
| 6 | beneficiary_weak | PowerCons | 0 | 2 | 0 | `identity` | +0.0000 | +0.1333 | +0.0000 | 2 | 4 | 4 |
| 7 | heldout_only | Herring | 0 | 0 | 0 | `identity` | +0.0000 | +0.0469 | +0.0000 | 0 | 3 | 1 |
| 8 | identity_B | BirdChicken | 0 | 2 | 0 | `identity` | +0.0000 | +0.0000 | +0.0000 | 2 | 5 | 4 |
